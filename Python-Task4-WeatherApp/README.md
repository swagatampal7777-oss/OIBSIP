...
- 🏙️  City input field for manual search.
- 🌡️ Displays current temperature, humidity, and condition.
- 🖼️ Shows weather icons corresponding to conditions.
- ⏳ Hourly forecast (next 6 hours).
- 📅 Daily forecast (next 5 days).
- 🔄 Unit toggle: Celsius ↔ Fahrenheit.
- ⚠️ Error messages shown inside GUI (not terminal).
...
- Learned basics of API integration with OpenWeatherMap.
- Took reference from Copilot for Tkinter GUI, API requests, and Pillow image handling.
- Gained confidence in organizing beginner Python projects.

## 📌 Future Improvements
- Add modern GUI themes.
- Show extended forecast (7–10 days).
